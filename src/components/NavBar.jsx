...
const NavBar = () => {
  ...
  return (
    <div className="shadow-nav bg-white bg-opacity-[6%] backdrop-blur-[20px] md:py-4 py-3">
          ...
          >
            {NAV_LINK_LIST.map((data, i) => (
              <li key={i}>
                <a
                  href={data.url}
                  className="font-saira px-4 py-7 hover:bg-light-grey duration-300 font-normal text-base text-white leading-157"
                >
                  {data.title}
                </a>
              </li>
